    ...
    <div id="appUI">
        <aside class="sidebar" id="appSidebar">
            <div class="user-profile" style="border-bottom: 1px solid rgba(239, 68, 68, 0.2);">
                ...
                <span class="text-muted" id="adminEmailDisplay"
                    style="font-size:0.8rem; display:block; margin-top:2px;">Loading session...</span>
            </div>
            ...
            <div class="sidebar-bottom">
                <a href="#" class="btn btn-ghost"
                    onclick="Swal.fire({icon:'info',title:'Coming Soon',text:'Settings panel is under construction.',background:'var(--glass-bg)',color:'var(--text-primary)',confirmButtonColor:'var(--aurora-1)'}); return false;"><i
                        class="fas fa-cog"></i> Settings</a>
                <a href="<?php echo get_logout_url('../'); ?>" class="btn btn-danger"><i
                        class="fas fa-sign-out-alt"></i> Logout</a>
                <div class="copyright"
                    style="margin-top:1rem; font-size:0.75rem; color:var(--text-muted); text-align:center;">
        ...
        <main class="main-content" id="main-content">
            ...
            <section class="admin-view active" id="view-overview">
                <div class="dashboard-header">
                    <div class="header-left">
                        <button class="mobile-menu-btn" id="sidebarToggleBtn" onclick="toggleSidebar()">
                ...
                <div class="admin-stats-grid">
                    <div class="admin-stat-card">
                        ...
                        <div>
                            ...
                            <div class="metric-value" id="stat-total-users"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                    <div class="admin-stat-card">
                        ...
                        <div>
                            ...
                            <div class="metric-value" id="stat-active-users"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                    <div class="admin-stat-card">
                        ...
                        <div>
                            ...
                            <div class="metric-value" id="stat-system-spent"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                    <div class="admin-stat-card">
                        ...
                        <div>
                            ...
                            <div class="metric-value" id="stat-system-saved"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                    <div class="admin-stat-card">
                        ...
                        <div>
                            ...
                            <div class="metric-value" id="stat-failed-logins"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                </div>
            ...
            <section class="admin-view" id="view-users">
                ...
                <div class="control-row"
                    style="display: flex; flex-direction: row; flex-wrap: nowrap; gap: 8px; width: 100%;">
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody id="usersTableBody">
                            <tr>
                                <td colspan="9" style="text-align:center; padding:3rem;"><i
                                        class="fas fa-circle-notch fa-spin fa-2x"></i></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <section class="admin-view" id="view-logs">
                ...
                <div class="control-row"
                    ...
                    <div class="search-input-wrapper" style="flex: 1; max-width: none;">
                        <i class="fas fa-search"></i>
                        <input type="text" id="logSearchInput" placeholder="Filter logs by email or action..."
                            onkeyup="filterLogsTable()">
                    </div>
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody id="logsTableBody">
                            <tr>
                                <td colspan="5" style="text-align:center; padding:3rem;"><i
                                        class="fas fa-circle-notch fa-spin fa-2x"></i></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <section class="admin-view" id="view-shield">
                ...
                <div class="admin-stats-grid">
                    <div class="admin-stat-card">
                        ...
                        <div>
                            ...
                            <div class="metric-value" id="shield-total-domains"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                    <div class="admin-stat-card" style="grid-column: span 2;">
                        ...
                        <div style="width: calc(100% - 60px);">
                            ...
                            <div class="metric-value font-mono" id="shield-last-sync"
                                style="font-size:1.15rem; margin-top:4px;"><i
                                    class="fas fa-circle-notch fa-spin fa-xs"></i></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="control-row" style="margin-bottom: 2rem;">
                    <button class="btn btn-primary" onclick="syncLiveBlocklist()"
                        style="background: linear-gradient(135deg, var(--aurora-1), var(--aurora-deep)); display: flex; align-items: center; gap: 8px; padding: 0.75rem 1.5rem; font-weight: 600;">
                        <i class="fas fa-sync-alt" id="syncShieldIcon"></i> Sync Live Blocklist
                    </button>
                </div>

                <div class="glass-card"
                    style="background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: var(--radius-xl); padding: 2rem; margin-top: 1rem;">
                    <h3
                        style="font-family: var(--font-display); font-size: 1.2rem; font-weight: 700; margin-bottom: 0.5rem; color: var(--text-primary);">
                        <i class="fas fa-search-location" style="color: var(--aurora-1); margin-right: 8px;"></i> Live
                        Domain Lookup
                    </h3>
                    <p class="text-secondary" style="font-size: 0.85rem; margin-bottom: 1.5rem;">
                        Verify whether a particular email domain is currently blacklisted and blocked by the Security
                        Shield.
                    </p>
                    <div style="display: flex; gap: 10px; width: 100%; flex-wrap: wrap;">
                        <input type="text" id="shieldDomainInput" placeholder="e.g. yopmail.com"
                            class="theme-input-select"
                            style="flex: 1; min-width: 250px; height: 44px; padding: 0.75rem 1rem; border-radius: 8px;">
                        <button class="btn btn-primary" onclick="checkDomainShield()"
                            style="height: 44px; display: inline-flex; align-items: center; justify-content: center; padding: 0 1.5rem; font-weight: 600;">
                            <i class="fas fa-search" style="margin-right: 6px;"></i> Lookup Domain
                        </button>
                    </div>
                    <div id="shieldCheckResult"
                        style="margin-top: 1.5rem; display: none; font-weight: 600; padding: 1rem; border-radius: 8px; font-size: 0.9rem;">
                    </div>
                </div>
            </section>
        </main>
