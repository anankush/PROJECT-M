...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base; ?>assets/css/user_dashboard.css">
...
<body>
    ...
    <div id="appUI" style="display: none; width: 100%;">
        <aside class="sidebar" id="appSidebar">
            ...
            <div class="sidebar-bottom">
                ...
                <div class="copyright">
                    &copy; <?php echo date("Y"); ?> PROJECT E<br>All rights reserved.
                </div>
            </div>
        </aside>
        ...
        <main class="main-content">
            <div class="dashboard-header">
                ...
                <div class="header-controls">
                    ...
                    <input type="text" id="monthFilter" class="theme-input-select" placeholder="Select Month">
    ...
    <style>
        .set-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(70px, 1fr)); gap: 10px; margin-bottom: 1rem; }
        ...
        .set-card.active { background: rgba(139, 92, 246, 0.2); border-color: var(--aurora-1); color: white; font-weight: 600; box-shadow: 0 0 10px rgba(139, 92, 246, 0.3); }
        .custom-field-row { display: flex; gap: 10px; margin-bottom: 10px; align-items: center; }
        .custom-field-row input { flex: 1; padding: 0.5rem; background: rgba(255,255,255,0.05); border: 1px solid var(--glass-border); color: white; border-radius: 4px; }
        .cf-remove { color: var(--danger); cursor: pointer; font-size: 1.2rem; }
        .hide-mobile { display: inline; }
        @media (max-width: 768px) { 
            .hide-mobile { display: none; } 
            #noteBtn { padding: 0.5rem 0.6rem !important; }
            #noteBtn i { font-size: 1.25rem; margin-right: 0 !important; }
            #monthFilter { width: 130px !important; padding: 0.5rem !important; }
            .header-controls { gap: 5px !important; }
        }
        input[type="number"]::-webkit-outer-spin-button, input[type="number"]::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; }
        input[type="number"] { -moz-appearance: textfield; appearance: textfield; }
        .swal2-actions { gap: 10px; } /* Adds spacing between the custom buttons */
    </style>
</body>
</html>
